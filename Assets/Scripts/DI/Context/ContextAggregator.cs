...
namespace DI
{
    ...
    {
        private readonly List<IReadOnlyContext> _contexts = new List<IReadOnlyContext>();
        private readonly Dictionary<Type, ISource> _combinedContext = new Dictionary<Type, ISource>();
        private readonly IErrorProvider _errorProvider;

        public ContextAggregator(IErrorProvider errorProvider) => _errorProvider = errorProvider;
        ...
        {
            if (_contexts.Contains(context) == false)
            {
